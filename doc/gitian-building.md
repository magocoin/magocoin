...
To build Magocoin (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/eastcoastcrypto/Magocoin
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/Magocoin.git
