...
In order to support loading of multiple wallets in magocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is magocoin.cpp.
...
Changes to magocoin.cpp
----------------------
magocoin.cpp is the entry point into magocoin-qt, and as such, will require some minor modifications to provide hooks for
