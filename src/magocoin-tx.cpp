...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Magocoin Core magocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  magocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded magocoin transaction") + "\n" +
                               "  magocoin-tx [options] -create [commands]   " + _("Create hex-encoded magocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded magocoin transaction
