...
/** Utility functions used by the Magocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Magocoin addresses in monospace font
...
// Parse "magocoin:" URI into recipient object, return true on successful parsing
