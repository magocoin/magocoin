                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Magocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Magocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and magocoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMAGO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Magocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Magocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Magocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Magocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Magocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Magocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Magocoin Core help message to get a list with possible Magocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Magocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Magocoin network", "", count));
}
...
{
    QString strTitle = tr("Magocoin Core"); // default title
...
/** Creates context menu, its actions, and magocoins up all the relevant signals for mouse events. */
