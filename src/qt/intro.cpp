...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Magocoin Core"),
     ...
     * override -datadir in the magocoin.conf file in the default data directory
     * (to be consistent with magocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
