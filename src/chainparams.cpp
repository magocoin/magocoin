...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0xc4b60791fa1f197fedf1f937528be360f96a34130c1e18c1971dc33109c6313c"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1533344408, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 22123;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Magocoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 90; // Magocoin: 1.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // Magocoin: 10 minutes (Slow launch - Block 288)
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "New York Times 03/Aug/2018 China Threatens New Tariffs on 0 Billion of U.S. Goods";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1533344408;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 916587;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xc4b60791fa1f197fedf1f937528be360f96a34130c1e18c1971dc33109c6313c"));
        assert(genesis.hashMerkleRoot == uint256("0x5ae8d825ade3041e4ffe3af5ca109a5010fb8fbb46fd9740826d1621cb7586ad"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Magocoin: 1 day
        nTargetSpacing = 1 * 60;  // Magocoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet magocoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet magocoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet magocoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet magocoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet magocoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Magocoin: 1 day
        nTargetSpacing = 1 * 60;        // Magocoin: 1 minutes
