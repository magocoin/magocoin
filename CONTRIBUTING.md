Contributing to Magocoin Core
============================

The Magocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Magocoin Core project, and is not to be
confused with overall Magocoin Network Protocol consensus changes.

Whether a pull request is merged into Magocoin Core rests with the project merge
...
Patches that change Magocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Magocoin consensus, it must have been
...
The project leader is the release manager for each Magocoin Core release.
